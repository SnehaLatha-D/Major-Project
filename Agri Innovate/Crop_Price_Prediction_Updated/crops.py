def crop(crop_name):
    ...
    "rice":["/static/images/rice.jpg", "W.B., U.P., Andhra Pradesh, Punjab, T.N.", "kharif","Bangladesh, Saudi Arabia, Iran"],
    ...
    "tomato":["/static/images/tomato.jpg", "Andhra Pradesh, Karnataka, Orissa, Maharashtra, Madhya Pradesh", "rabi", "United Arab Emirates, Saudi Arabia, Nepal"],
    "onion":["/static/images/onion.jpg", "Maharashtra, Karnataka, Madhya Pradesh, Gujarat, Bihar", "rabi", "Bangladesh, Malaysia, Sri Lanka"],
    "potato":["/static/images/potato.jpg", "Uttar Pradesh, West Bengal, Bihar, Gujarat, Madhya Pradesh", "rabi", "United Arab Emirates, Sri Lanka, Nepal"],
